            ...
            <div class="col-md-8 mb-4">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        @if($post->user)
                            <img src="{{ $post->user->profile_image ? Storage::disk('s3')->url($post->user->profile_image) : 'https://via.placeholder.com/40' }}" class="rounded-circle me-3" style="width: 40px; height: 40px;">
                    ...
                    <img src="{{ Storage::disk('s3')->url($post->image_path) }}" class="card-img-top">
                    <div class="card-body">
